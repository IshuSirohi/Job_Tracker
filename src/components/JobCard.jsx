import { Link } from "react-router-dom";
 ...
 function JobCard({ job, onDelete }) {
  ...
  return (
    <div className="bg-white/20 backdrop-blur-lg border border-white/20 rounded-xl shadow-lg p-6 flex flex-col justify-between h-full
  ...
  style={{ willChange: "transform, box-shadow" }}>
      ...
      <div className="mt-4 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Link to={`/edit-job/${job.id}`} className="px-3 py-1 text-sm bg-yellow-400 text-gray-900 rounded hover:bg-yellow-300">
                Edit
             </Link>
